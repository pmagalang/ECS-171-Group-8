...
def gen_melspectrogram(wav_file):
    ...
    plt.axis('off')
    plt.savefig('../Images/melspec.png', bbox_inches="tight", pad_inches = 0, transparent = True)
...
def gen_Tonnetz(wav_file):
    ...
    plt.axis('off')
    plt.savefig('../Images/tonnetz.png', bbox_inches="tight",pad_inches = 0,transparent=True)
...
def gen_Chroma(wav_file):
    ...
    plt.axis('off')
    plt.savefig('../Images/chroma.png', bbox_inches="tight",pad_inches = 0,transparent=True)
